...
namespace ft
{
    ...
    struct _list_iterator   //��ӹ޾Ƽ� ���� �� �ʿ� ����.
    {
        ...
        typedef T*                                  pointer;
        typedef T&                                  reference;
        typedef std::bidirectional_iterator_tag     iterator_category;  //���ͷ������� ������ �����ִ� ǥ����
    ...
    protected:
        ...
        _list_node_base     sentry_node;    //gnu�� �ٸ��� ���� �и�ó��
        ...
        void _init()    //���ʳ�尡 �ڱ� �ڽ��� ����Ų��. �ؽ�Ʈ ������ ���δ�. ��Ʈ����尡 �׻� �������� ��ġ/
        {
    ...
    // ########## (constructor) ##########
        ...
        //range (3)	
        template <class InputIterator>  //ex) list(int 10, int 2)�� �ϸ� �� �Ʒ� �����ڰ� ȣ��ȴ�. Ÿ���� �ٸ��� ����
    ...
    {
        _init();
        typedef typename ft::is_integer<InputIterator>::type is_integer_type;   //integer���� Ȯ���ؼ� �б�ó��
